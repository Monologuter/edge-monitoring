<template>
  <div class="sf-page">
    <div class="sf-page-head">
      <div>
        <h2 class="sf-page-title">液位信息</h2>
        <div class="sf-page-sub">液位设备与阈值配置</div>
      </div>
...
async function load() {
  loading.value = true;
  try {
    const data = await http.get<PageResponse<DeviceVO>>(`/api/v1/devices?page=${page.value}&pageSize=${pageSize.value}&deviceType=5`);
